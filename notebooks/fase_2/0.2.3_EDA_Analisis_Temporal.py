# ============================================================
# FASE 2 — EDA | 02c: Analisis Temporal
# ============================================================
...
# ── 4. Agregasi per tahun (untuk tren detail) ─────────────────
...
# ── 5. Agregasi per bulan (seasonality) ───────────────────────
...
# -- 6a. Rata-rata total gol per dekade (bar)
ax = axes[0, 0]
...
# -- 6b. Stacked bar: team vs opp goals per dekade
ax = axes[0, 1]
...
# -- 6c. Tren rata-rata total gol per tahun (line)
ax = axes[1, 0]
...
# -- 6d. Jumlah pertandingan per tahun (volume data)
ax = axes[1, 1]
...
# -- 6e. Seasonality: rata-rata gol per bulan
ax = axes[2, 0]
...
# -- 6f. Jumlah pertandingan per bulan
ax = axes[2, 1]
